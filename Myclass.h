...
// Thu Jul 28 11:36:56 2022 by ROOT version 6.26/02
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: recon_data_uboone.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   void DrawSingleCanvas(TCanvas * canvas1,TH1F * histo,TString label, TLegend *leg1);
   void DrawSecondHistOnCanvas(TCanvas * canvas1,TH1F * histo,TString label, Color_t color, TLegend *leg1);
   TLegend* InitializeLegend(TCanvas *canvas1);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("muons_test.root.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("muons_test.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("muons_test.root:/nuselection");
