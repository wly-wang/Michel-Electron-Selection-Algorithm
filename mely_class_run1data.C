#define mely_class_run1data_cxx
#include "mely_class_run1data.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <vector>
...
//by  b_branchname->GetEntry(ientry); //read only this branch
    ...
    TProfile* h_mu_ly_reco_x = new TProfile("h_mu_ly_reco_x","Total Light Yield Measurement Using Reconstructed MC Muons (Run1)",10,-1,257,"");
    ...
    greater_than_50.open("michel_greater_than_50mev_run1.txt", ios::app | ios::out);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++)
   {
    ...
    unique_ptr<TFile> myFile(TFile::Open("run1_analyz_outputs.root", "RECREATE"));
    ...
    //print to .root file and pdf
    c25 -> Print("plots.ps");
    myFile -> WriteObject(c25, "Run1 Muon Reconstructed Light Yield Measurement (x)");
    ...
    //print to .root file and pdf
    c27 -> Print("plots.ps");
    myFile -> WriteObject(c27, "Run1 Michel Reconstructed Light Yield Measurement (x)");
