...
// Sun Aug 20 11:13:14 2023 by ROOT version 6.26/06
// from TTree NeutrinoSelectionFilter/Neutrino Selection TTree
// found on file: run3_data_ntuple.root
//////////////////////////////////////////////////////////

#ifndef mely_class_run3data_h
#define mely_class_run3data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   mely_class_run3data(TTree *tree=0);
   virtual ~mely_class_run3data();
...
#ifdef mely_class_run3data_cxx
mely_class_run3data::mely_class_run3data(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run3_data_ntuple.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run3_data_ntuple.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("run3_data_ntuple.root:/nuselection");
...
mely_class_run3data::~mely_class_run3data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t mely_class_run3data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mely_class_run3data::LoadTree(Long64_t entry)
{
...
void mely_class_run3data::Init(TTree *tree)
{
...
Bool_t mely_class_run3data::Notify()
{
...
void mely_class_run3data::Show(Long64_t entry)
{
...
Int_t mely_class_run3data::Cut(Long64_t entry)
{
...
#endif // #ifdef mely_class_run3data_cxx
